...
export default function App() {
    ...
    const setVolumeInDatabase = () => {
		...
		set(volumeRef, volume)
			...
			.catch(error => {
				console.error('Failed to set volume in database:', error);
			});
	};
    ...
    return (
        <div className="app_wrapper">
            ...
            <div className="item">
                ...
                <p>STATUS: ON</p>
                <p>INITIALIZATION: FINISHED</p>
                <p>DETECTION: TRUE</p>
            </div>
            <div className="item">
                <h2 className="item_title">Code-lock</h2>
                <p>STATUS: ACTIVE</p>
                <p>REMAINING TIME: 00:50 / 5:00</p>
            </div>
            ...
            <div className="item">
                ...
                <div className='item_detail'>
                    ...
                    <div className="detail_row">
                        ...
                        <button onClick={setVolumeInDatabase}>Set Volume</button>
                    </div>
                </div>
            </div>
        </div>
